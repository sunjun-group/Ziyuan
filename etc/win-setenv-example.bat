...
rem set REPO_THIRD_PARTY_URL=http://202.94.70.100:8081/nexus/content/repositories/thirdparty
rem set REPO_THIRD_PARTY_URL=http://localhost:8081/nexus/content/repositories/thirdparty/
set REPO_THIRD_PARTY_URL=http://52.89.202.3:8081/nexus/content/repositories/thirdparty
