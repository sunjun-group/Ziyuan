...
package icsetlv.trial.jpda.gui;

import java.io.*;
import com.sun.jdi.*;
import icsetlv.trial.jpda.bdi.*;
...
public class Environment {
    ...
    public void viewSource(String fileName) {
        ...
        icsetlv.trial.jpda.gui.GUI.srcTool.showSourceFile(fileName);
    }
    ...
    public void viewLocation(Location locn) {
        ...
        icsetlv.trial.jpda.gui.GUI.srcTool.showSourceForLocation(locn);
    }
