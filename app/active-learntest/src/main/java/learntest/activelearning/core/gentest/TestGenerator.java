...
package learntest.activelearning.core.gentest;
...
public class TestGenerator {
	...
	public GentestResult genTestAccordingToSolutions(GentestParams params, List<BreakpointValue> inputData,
		...
		Module injectorModule = new GentestModules(prjClassLoader);
		((GentestModules)injectorModule).enter(TestcaseGenerationScope.class);
		...
		((GentestModules)injectorModule).exit(TestcaseGenerationScope.class);
