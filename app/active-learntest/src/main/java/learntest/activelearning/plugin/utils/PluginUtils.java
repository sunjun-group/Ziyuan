...
public class PluginUtils {
	...
	public static IProject getSpecificJavaProjectInWorkspace(){
		return getSpecificJavaProjectInWorkspace(ActiveLearnTestConfig.getInstance().getProjectName());
	}
	...
	public static MethodDeclaration findSpecificMethod(String className, String methodName, int lineNumber) {
		return findSpecificMethod(ActiveLearnTestConfig.getInstance().getProjectName(), className, methodName, lineNumber);
	}
	 ...
	 * {@link PluginUtils#getMethodWthSignature(String, String, int)}
	 */
...
//					return packageFragmentRoot;
	...
	public static IJavaProject getJavaProject() {
		return getJavaProject(ActiveLearnTestConfig.getInstance().getProjectName());
	}
