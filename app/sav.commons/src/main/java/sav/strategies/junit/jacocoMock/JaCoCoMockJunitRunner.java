...
public class JaCoCoMockJunitRunner extends JunitRunner {
	...
	public JunitResult runTestcases(JunitRunnerParameters params)
		...
		timer.newPoint("extract bkps");
		System.out.println(TextFormatUtils.printListSeparateWithNewLine(timer.getResults()));
		return null;
	}
