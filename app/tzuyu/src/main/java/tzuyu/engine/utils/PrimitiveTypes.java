...
public final class PrimitiveTypes {
	...
	public static final Map<String, Class<?>> typeNameToPrimitiveOrString = new LinkedHashMap<String, Class<?>>();
	static {
	 ...
	 */
	public static boolean stringLengthOK(String s, int stringMaxLength) {
		if (s == null) {
			throw new IllegalArgumentException("s is null");
		}
		...
		if (length * 6 < stringMaxLength) {
			stringLengthOKCached.put(s, true);
			return true;
		}

		boolean retval = StringEscapeUtils.escapeJava(s).length() <= stringMaxLength;
