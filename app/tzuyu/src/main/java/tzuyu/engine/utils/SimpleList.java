...
public abstract class SimpleList<T> {
  ...
  /**
   * Get the sublist of statements starting at index <code>fromIndex</code>
   * (inclusive) to statement at index <code>toIndex</code>(exclusive).
   * 
   * @param fromIndex
   * @param toIndex
   * @return
  ...
  public List<T> subList(int fromIndex, int toIndex) {
    return toJDKList().subList(fromIndex, toIndex);
  }
}
