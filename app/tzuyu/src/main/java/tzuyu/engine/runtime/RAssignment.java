...
public class RAssignment extends StatementKind implements Serializable {
  ...
  public static RAssignment nullOrZeroDecl(Class<?> type) {
    ...
    if (Integer.TYPE.equals(type))
      return new RAssignment(Integer.TYPE, (Integer.valueOf(0)).intValue());
    ...
    if (Double.TYPE.equals(type))
      return new RAssignment(Double.TYPE, (Double.valueOf(0)).doubleValue());
