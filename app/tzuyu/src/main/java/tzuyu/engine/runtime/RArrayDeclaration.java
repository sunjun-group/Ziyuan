...
public class RArrayDeclaration extends StatementKind implements Serializable {
  ...
  public RArrayDeclaration(Class<?> componentType, int size) {
    ...
    if (size < 0) {
      throw new IllegalArgumentException("array size is negative: " + size);
    }
