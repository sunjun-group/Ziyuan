...
public class TzuYuAction extends Action {
  ...
  public static TzuYuAction fromMethod(MethodInfo method) {
    try {
      Class<?> RMethod = Class.forName("runtime.RMethod");
      Method methodMethod = RMethod.getMethod("getMethod", Method.class);
...
//    }
  ...
  public static TzuYuAction fromCtor(ConstructorInfo ctor) {
    try {
      ...
      Object resulObject = rctorMethod.invoke(null, ctor.getConstructor());
