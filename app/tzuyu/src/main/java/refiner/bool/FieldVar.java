...
public class FieldVar implements Var {
  ...
  public static
      FieldVar getVar(StatementKind stmt, int argIdx, ArtFieldInfo fi) {
  ...
  public String toString() {
    ...
    return type + "." + field.getFullName() + "(" + Integer.toString(argIndex)
        + ")";
  }
  ...
  public boolean equals(Object o) {
    ...
    return statement.equals(obj.statement) 
