...
public class OneBoolEq1Template extends OneFeatureTemplate {
	
	private double a;
	
	public OneBoolEq1Template(List<List<ExecValue>> passValues, List<List<ExecValue>> failValues) {
	...
	public boolean check() {
		a = 1; // passValues.get(0).get(0).getDoubleVal();
