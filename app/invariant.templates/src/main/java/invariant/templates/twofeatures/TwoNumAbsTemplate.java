...
public class TwoNumAbsTemplate extends TwoFeaturesTemplate {

	public TwoNumAbsTemplate(List<List<ExecValue>> passExecValuesList, List<List<ExecValue>> failExecValuesList) {
