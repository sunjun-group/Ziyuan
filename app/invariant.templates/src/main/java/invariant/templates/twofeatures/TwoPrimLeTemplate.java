...
public class TwoPrimLeTemplate extends TwoFeaturesTemplate {

	public TwoPrimLeTemplate(List<List<ExecValue>> passExecValuesList, List<List<ExecValue>> failExecValuesList) {
