...
public class TwoPrimSquareTemplate extends TwoFeaturesTemplate {

	public TwoPrimSquareTemplate(List<List<ExecValue>> passExecValuesList, List<List<ExecValue>> failExecValuesList) {
