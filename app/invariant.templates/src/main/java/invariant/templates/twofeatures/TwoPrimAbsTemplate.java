...
public class TwoPrimAbsTemplate extends TwoFeaturesTemplate {

	public TwoPrimAbsTemplate(List<List<ExecValue>> passExecValuesList, List<List<ExecValue>> failExecValuesList) {
	...
	public boolean check() {
		...
		for (List<ExecValue> evl : passExecValuesList) {
			...
			if (v1 != Math.abs(v2)) return false;
		}
