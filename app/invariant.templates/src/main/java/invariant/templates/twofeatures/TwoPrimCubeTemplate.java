...
public class TwoPrimCubeTemplate extends TwoFeaturesTemplate {

	public TwoPrimCubeTemplate(List<List<ExecValue>> passExecValuesList, List<List<ExecValue>> failExecValuesList) {
