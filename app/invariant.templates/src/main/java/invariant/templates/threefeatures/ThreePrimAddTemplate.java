...
public class ThreePrimAddTemplate extends ThreeFeaturesTemplate {

	public ThreePrimAddTemplate(List<List<ExecValue>> passExecValuesList, List<List<ExecValue>> failExecValuesList) {
