...
public class ThreePrimMulTemplate extends ThreeFeaturesTemplate {

	public ThreePrimMulTemplate(List<List<ExecValue>> passExecValuesList, List<List<ExecValue>> failExecValuesList) {
