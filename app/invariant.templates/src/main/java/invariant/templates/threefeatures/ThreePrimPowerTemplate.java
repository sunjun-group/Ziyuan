...
public class ThreePrimPowerTemplate extends ThreeFeaturesTemplate {

	public ThreePrimPowerTemplate(List<List<ExecValue>> passExecValuesList, List<List<ExecValue>> failExecValuesList) {
