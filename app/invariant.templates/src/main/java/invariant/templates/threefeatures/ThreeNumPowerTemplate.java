...
public class ThreeNumPowerTemplate extends ThreeFeaturesTemplate {

	public ThreeNumPowerTemplate(List<List<ExecValue>> passExecValuesList, List<List<ExecValue>> failExecValuesList) {
