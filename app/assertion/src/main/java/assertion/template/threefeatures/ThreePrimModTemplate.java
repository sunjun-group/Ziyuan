...
public class ThreePrimModTemplate extends ThreeFeaturesTemplate {

	public ThreePrimModTemplate(List<List<ExecValue>> passExecValuesList, List<List<ExecValue>> failExecValuesList) {
	...
	public List<List<Eq<?>>> sampling() {
		...
		sample3.add(new Eq<Number>(v3, 3.0));
