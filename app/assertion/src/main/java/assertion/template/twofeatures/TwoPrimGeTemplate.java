...
public class TwoPrimGeTemplate extends TwoFeaturesTemplate {

	public TwoPrimGeTemplate(List<List<ExecValue>> passExecValuesList, List<List<ExecValue>> failExecValuesList) {
