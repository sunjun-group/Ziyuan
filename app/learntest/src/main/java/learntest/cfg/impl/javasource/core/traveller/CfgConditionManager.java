package learntest.cfg.impl.javasource.core.traveller;
...
import learntest.cfg.impl.javasource.core.CfgFalseEdge;
import learntest.cfg.impl.javasource.core.CfgNode;
import learntest.cfg.impl.javasource.core.CfgTrueEdge;
...
public class CfgConditionManager {
	...
	public CfgConditionManager(ContextFreeGrammar cfg) {
