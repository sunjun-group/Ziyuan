...
import learntest.cfg.impl.javasource.core.CfgNode.Type;
import learntest.cfg.impl.javasource.core.graph.Graph;

public class CFG extends Graph<CfgNode, CfgEdge> implements ContextFreeGrammar {
