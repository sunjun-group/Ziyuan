...
public class ParamGeneratorConfig {
	...
	public static final Ranges<Float> DEFAULT_FLOAT_RANGES = Ranges.of(Float.MIN_VALUE, Float.MAX_VALUE);
	public static final Ranges<Double> DEFAULT_DOUBLE_RANGES = Ranges.of(Double.MIN_VALUE, Double.MAX_VALUE);
