...
public class GenTestPreferences extends TzPreferences implements Cloneable {
	...
	private static String getDefaultSearchScope() {
		...
		objectTypeScope.setFullyQualifiedName(PluginConstants.OBJECT_CLASS_NAME);
		...
		defaultScope.put(PluginConstants.OBJECT_CLASS_NAME, objectTypeScope);
		
		TypeScope classTypeScope = new TypeScope();
		classTypeScope.setFullyQualifiedName(PluginConstants.CLASS_CLASS_NAME);
		classTypeScope.setScope(SearchScope.SOURCE);
		defaultScope.put(PluginConstants.CLASS_CLASS_NAME, classTypeScope);
