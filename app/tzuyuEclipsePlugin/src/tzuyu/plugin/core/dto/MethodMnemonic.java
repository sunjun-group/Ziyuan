...
public class MethodMnemonic {
  ...
  private static String getStableSignature(IMethod method) throws JavaModelException {
    ...
    for (String parameter : parameters) {
      String sig = ResourcesUtils.getUnresolvedFullyQualifiedMethodSignature(method, parameter);
      methodSignature.append(sig);
    }
    methodSignature.append(')');
    String sig = ResourcesUtils.getUnresolvedFullyQualifiedMethodSignature(method, method.getReturnType());
    methodSignature.append(sig);
