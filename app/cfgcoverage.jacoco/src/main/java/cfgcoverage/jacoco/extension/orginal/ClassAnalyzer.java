 ...
 *    
 *******************************************************************************/
package cfgcoverage.jacoco.extension.orginal;
...
public class ClassAnalyzer extends ClassProbesVisitor {
	// LLT: make this field visible for extended class.
	protected final ClassCoverageImpl coverage;
	protected final boolean[] probes;
	...
	public MethodProbesVisitor visitMethod(final int access, final String name,
		...
		return createMethodAnalyzer(name, desc, signature);
	}

	/*
	 * LLT: Extract for overriding in extended class.
	 */
	protected MethodProbesVisitor createMethodAnalyzer(final String name, final String desc, final String signature) {
