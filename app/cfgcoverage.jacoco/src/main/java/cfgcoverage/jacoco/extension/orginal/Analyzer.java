...
public class Analyzer {
	...
	// LLT: make this visible for extended class
	...
	private ClassVisitor createAnalyzingVisitor(final long classid,
		...
		final ClassCoverageImpl coverage = new ClassCoverageImpl(className,
				classid, noMatch);
		final ClassProbesVisitor analyzer = createClassAnalyzer(probes, coverage);
	 ...
	 */
	protected ClassProbesVisitor createClassAnalyzer(final boolean[] probes, final ClassCoverageImpl coverage) {
		return new ClassAnalyzer(coverage, probes,
				stringPool) {
			@Override
