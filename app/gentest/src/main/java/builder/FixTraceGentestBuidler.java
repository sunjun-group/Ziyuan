 ...
 *
 */
public class FixTraceGentestBuidler extends GentestBuilder {
	...
	public FixTraceGentestBuidler(int numberOfTcs) {
	...
	public FixTraceGentestBuidler forClass(Class<?> clazz) {
		this.clazz = clazz;
		return this;
	}
	
	public FixTraceGentestBuidler method(String methodNameOrSign, String alias) {
		findAndAddTestingMethod(methodNameOrSign);
		aliasMethodMap.put(testingMethods.size() - 1, alias);
		return this;
	}
	
	public FixTraceGentestBuidler method(String methodNameOrSign) {
		findAndAddTestingMethod(methodNameOrSign);
		return this;
	}
	...
	public class EvaluationMethod {
		 ...
		 * "f.x", "b.x", "b.return" 
		 */
		public FixTraceGentestBuidler param(String... params) {
			if (params != null) {
			...
			return FixTraceGentestBuidler.this;
		}
