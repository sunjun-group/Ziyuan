...
import testdata.core.commons.utils.SolverTestData;
...
public class MethodUtilsTest {
	...
	@Test
	public void testFindMethod_SecantSolver() {
		Method method = MethodUtils.findMethod(SolverTestData.class, "solve");
